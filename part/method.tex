...
We train our model on L1 and L2 loss function: 

\begin{equation} \label{eq:count}  % TODO: L1
C(I_i) = \sum_{p \in I_{i}} F_{i}(p)
\end{equation}

\begin{equation} \label{eq:count}  % TODO: L2 
C(I_i) = \sum_{p \in I_{i}} F_{i}(p)
\end{equation}

\begin{equation} \label{eq:count} % TODO: L1 + L2 
C(I_i) = \sum_{p \in I_{i}} F_{i}(p)
\end{equation}
